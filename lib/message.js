...
class Room extends Databasey {
  ...
  constructor(room, provider) {
    ...
    if(room instanceof Object) {
         ...
         *
         * @name Room.prototype.initialised
         * @type {bool}
         */
       ...
       * in this room
       *
       * @name Room.prototype.dialogState
       * @type {String}
       */


       this.values.dialogState = (room instanceof Object) ? room.dialogState : null;
...
['initialised', 'type', 'owner', 'dialogState'].forEach(prop => {

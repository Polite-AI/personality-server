...
class Room {
  ...
  constructor(room, provider) {
     ...
     * @type {bool}
     */
    this.initialised = (room instanceof Object) ? room.initialised : null;
    /**
     ...
     * @type {String}
     */
    this.type = (room instanceof Object) ? room.type : null;
    /**
     ...
     * @type {String}
     */
    this.owner = (room instanceof Object) ? room.owner : null;
    /**
...
// Want to add identical setters for some room properties and this is the
// least horrible way I can think of...
//
['initialised', 'type', 'owner'].forEach(prop => {
  Object.defineProperty(Room, prop, {
    set [prop](value) {
      this[prop] = value;
      console.log(`set ${prop} = ${value} and calling updateroom(this, '${prop}'')`)
